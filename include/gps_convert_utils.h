...
inline double pi = 3.14159265358979;

/* Ellipsoid model constants (actual values here are for WGS84) */
inline double sm_a = 6378137.0;
inline double sm_b = 6356752.314;
inline double sm_EccSquared = 6.69437999013e-03;
inline double UTMScaleFactor = 0.9996;
 ...
 *
 */
inline double RadToDeg(double rad) { return (rad / pi * 180.0); }
 ...
 *
 */
inline void MapLatLonToXY(double phi, double lambda, double lambda0,
                          UTMCoor &xy) {
 ...
 *
 */
inline void MapXYToLatLon(double x, double y, double lambda0,
                          WGS84Corr &philambda) {
 ...
 *
 */
inline void LatLonToUTMXY(double lat, double lon, int zone, UTMCoor &xy) {
 ...
 *
 */
inline void UTMXYToLatLon(double x, double y, int zone, bool southhemi,
                          WGS84Corr &latlon) {
  double cmeridian;
